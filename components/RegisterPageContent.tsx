...
// event/config data, just inside a different page shell (public
// SiteHeader vs. the dashboard chrome). No data-fetching or matching
// logic lives here; both callers pass in whatever getSoonestUpcomingEvent()
// + getRegisterPageConfig() already returned.
